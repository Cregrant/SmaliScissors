...
public class Concurrent {
    ...
    public static final Semaphore compressSemaphore = new Semaphore(getThreadsByMemory(600));
    public static final Semaphore runPatcherSemaphore = new Semaphore(getThreadsByMemory(600));
